...
export default function Edit({ parent, parentType, contact, auth }) {
    const parentName = parent.name || (parentType === 'lead' ? 'Lead' : 'Customer');
    const backUrl = `/${parentType}s/${parent.id}`;

    return (
        <AdminLayout user={auth?.user}>
            <Head title={`Edit Contact Person - ${contact.name}`} />

            <div className="page-header">
                <h1 className="page-title">Edit Contact Person</h1>
                <p className="page-subtitle">Update contact person information</p>
            </div>
                ...
                <div className="col-lg-8">
                    <div className="admin-card">
                        <div className="card-header">
                            <h2 className="card-title">Contact Person Information</h2>
                        </div>
