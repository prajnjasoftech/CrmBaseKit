...
export default function Edit({ business, industries, countries, auth }) {
    ...
    return (
        <AdminLayout user={auth?.user}>
            ...
            <div className="page-header">
                ...
                <p className="page-subtitle">Update business information</p>
            </div>
                    ...
                    <div className="admin-card mt-4">
                        ...
                        <div className="card-body">
                            <dl className="mb-0">
                                ...
                                <dd className="mb-0">{new Date(business.updated_at).toLocaleDateString()}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
